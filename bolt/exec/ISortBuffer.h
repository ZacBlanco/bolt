...
/// Interface shared by the legacy SortBuffer and the staged parallel sort
/// implementation. This mirrors the shape introduced by mergepath.patch while
/// keeping the legacy SortBuffer as the default implementation.
class ISortBuffer {
 public:
